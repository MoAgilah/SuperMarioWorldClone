...
void YoshiIsland1::Update(float deltaTime)
{
	/*
...
void YoshiIsland1::Render(IRenderer* renderer)
{
	/*
...
void YoshiIsland1::CheckIsInView()
{
	/*
	auto& camera = GameManager::Get()->GetCamera();
...
void YoshiIsland1::AddObject(const Vector2f& pos)
{
	/*
...
void YoshiIsland1::AddForeGroundSprites()
{
	/*
...
void YoshiIsland1::RenderGUI(IRenderer* renderer)
{
}